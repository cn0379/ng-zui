...
export class NzSelectTopControlComponent implements OnChanges, OnInit, OnDestroy {
    ...
    @Input() placeHolder: string | TemplateRef<ZSafeAny> | null = null;
    @Input() open = false;
    ...
    @Input() maxTagPlaceholder: TemplateRef<{ $implicit: ZSafeAny[] }> | null = null;
    ...
    trackValue(_index: number, option: NzSelectTopControlItemType): ZSafeAny {
    ...
    constructor(
        ...
        @Host() @Optional() public noAnimation: ZNoAnimationDirective | null
    ) { }
