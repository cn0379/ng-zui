...
export class ZWaveRenderer {
  ...
  get waveAttributeName(): string {
    return this.insertExtraNode ? 'z-click-animating' : 'z-click-animating-without-extra-node';
  }
  ...
  private fadeOutWave(): void {
    ...
    if (this.isValidColor(waveColor)) {
      ...
      [z-click-animating-without-extra-node='true']::after, .z-click-animating-node {
    ...
    if (this.insertExtraNode) {
      ...
      this.extraNode.className = 'z-click-animating-node';
